...
static const char *fonts[]          = { "Hack Nerd Font:size=9", "Symbols Nerd Font:size=9", "OldHungarian:size=9" };
...
static const char col_gray4[]       = "#f7cdb0";
...
//static const char *tags[] = { "Мир", "Вера", "Тишина", "Любовь", "Мудрость", "Гармония", };
static const char *tags[] = { "𐳺", "𐳻", "𐳼", "𐳽", "𐳾", "𐳿", "𐳓𐳉𐳍𐳋𐲖", "𐳙𐳉𐳦𐳤𐲑", "𐳘𐳛𐳢𐳁𐳬𐳦𐳙𐳉𐲥" };
