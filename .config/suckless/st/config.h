...
static char *font2[] = { "Apple Color Emoji:pixelsize=13:antialias=true:autohint=true", "OldHungarian:pixelsize=13", "JetBrainsMono Nerd Font:pixelsize=13:antialias=true:autohint=true" };
